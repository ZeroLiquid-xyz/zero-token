...
contract Deposit {
    ...
    function deposit(address _tokenContract, uint256 _amount) external {
        ERC20Permit(_tokenContract).transferFrom(msg.sender, address(this), _amount);
    ...
    function depositWithPermit(
        ...
        external
    {
        ERC20Permit(_tokenContract).permit(_owner, _spender, _value, _deadline, _v, _r, _s);

        ERC20Permit(_tokenContract).transferFrom(_owner, address(this), _amount);
    ...
    function withdraw(address _tokenContract, uint256 _amount) external {
        ...
        ERC20Permit(_tokenContract).transfer(msg.sender, _amount);
